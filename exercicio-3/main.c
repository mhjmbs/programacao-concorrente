...
int main(int argc, char** argv) {
    ...
    printf("Foram encontrados %lld primos no intervalo [%lld, %lld).\n", ans.prime_cnt, s0, s0+n);
    printf("A thread que mais encontrou primos foi a %ld, com um total de %lld primos.\n", tid[ans.winner], score[ans.winner]);
